...
uint256 hashGenesisBlock("0xa797f328f920f3a67aeb30f9fe776434b15448e61932d7ff8ebf99d4028cd369");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(503421396); // Unstakeable: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "Unstakeable Signed Message:\n";
...
{
    // Unstakeable: IsDust() detection disabled, allows any valid dust to be relayed.
...
{
    int64 nSubsidy = 1100000000000;

    // Subsidy is cut in half every 840000 blocks, which will occur approximately every 4 years
    nSubsidy >>= (nHeight / 15000); // Unstakeable: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 60; // Unstakeable: 3.5 days
static const int64 nTargetSpacing = 60; // Unstakeable: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // Unstakeable: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Unstakeable: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // Unstakeable: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x8e3cf288a169ac892680ff692b9b4d09be22386fb117863a2861f6bde0a024f1");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Welcome to the future of crypto - Judy";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 1100000000000;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("537b78ae4beff70611cba73a1fd414785261c0fcb6493391b96b228a35c97636d8aa29e1839e825f0032a41299514cadfbe0303050adb804542fe823579b28cd33") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1454595726;
        block.nBits    = 503421396;
        block.nNonce   = 3621373336;

        if (fTestNet)
        {
            block.nTime    = 1454595726;
            block.nNonce   = 793068011;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xecaa0ed51da5da261a6e52a91a49c791ed653f204765d99a99fc5e70b5697674"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // Unstakeable: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("UnstakeableMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("UnstakeableMiner : ProcessBlock, block not accepted");
    }
